...
export const he = {
  ...
  settings: {
    ...
    privacyBody:
      'המיקום שלכם נשאר על הטלפון ואינו נשלח לשום שרת שלנו. היוצא מן הכלל היחיד הוא חיפוש כתובת או לחיצה על המפה: הטקסט או שתי הקואורדינטות עוברים לשירות המיפוי של המכשיר — Apple ב‑iOS, Google באנדרואיד — כדי לקבל שם של מקום. מרגע ההפעלה האפליקציה לא נוגעת ברשת בכלל.',
