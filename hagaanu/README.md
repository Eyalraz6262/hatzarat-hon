...
הממשק משתמש ב‑**Assistant** — גופן שעוצב לעברית (רישיון SIL OFL, מותר בהחלט
בשימוש מסחרי), עם סט לטיני תואם. הגופן מוטמע באפליקציה ולא נטען מהרשת.

למה לא גופן המערכת: העברית שלו קריאה אבל לא יפה — המשקלים לא אחידים ואותיות
כמו ם/ס/ט מאבדות הבחנה בגדלים קטנים. חשוב מזה, במחרוזות מעורבות כמו "300 מ׳"
או "1.5 ק״מ" הספרות והאותיות נראות כמו שני גופנים נפרדים. Assistant פותר את שניהם.

המשקל נבחר תמיד על ידי בחירת *פנים* (`Assistant_700Bold`) ואף פעם לא דרך
`fontWeight` — אנדרואיד לא מסנתז משקלים למשפחה בשם מפורש ופשוט היה נופל בשקט
לגופן ברירת מחדל.

מסך הפתיחה מוחזק עד שהגופנים נטענים, כדי שלא תהיה הבזקה של גופן מערכת ואז
reflow. אם טעינת הגופן נכשלת — האפליקציה עולה בכל זאת עם גופן המערכת; גופן
לא ימנע ממשתמש להפעיל התראה.
...
├── theme/                     צבעים, מרווחים, גופן Assistant, סגנון מפה כהה
